...
- Inception の成果物範囲を requirements、acceptance、user-stories、use-cases、codebase-analysis、units、Unit Design Brief、bolts、traceability、decisions、state.json に限定する。
...
| `no-inception-task-generation` | 完了 | Inception では `tasks.md` を作らず、Task 生成を Construction へ送る。 | `/var/folders/3s/p2xl_vd524b4lk78cb6fz5nh0000gn/T/amadeus-inception-eval.20260627-hgfmNl/no-inception-task-generation/checks.md` |
| `construction-task-handoff` | 完了 | Bolt に Construction で Task 化できる完了条件、依存、証拠候補を残す。 | `/var/folders/3s/p2xl_vd524b4lk78cb6fz5nh0000gn/T/amadeus-inception-eval.20260627-hgfmNl/construction-task-handoff/checks.md` |
...
rg -n 'Ideation|guided|refine|repair|Requirements Review Gate|Codebase Analysis Gate|Construction Task 生成|greenfield|Spec|実装' skills/amadeus-inception/SKILL.md
git diff --check
```

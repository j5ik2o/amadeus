...
回答に記録対象の判断が含まれる場合は、Intent の入れ物作成と同じ変更で `initialization/grillings.md` と `initialization/grillings/Gxxx-*.md` を対象 Intent 配下に作る。
...
- 記録対象の質問と回答が発生した場合だけ、`.amadeus/intents/<intent-id>-<slug>/initialization/grillings.md`
- 記録対象の質問と回答が発生した場合だけ、`.amadeus/intents/<intent-id>-<slug>/initialization/grillings/Gxxx-*.md`

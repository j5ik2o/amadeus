...
|---|---|---|---|---|---|---|
| 入力テーマを Discovery Brief に整理できる | recommended | 未作成 | 大きな入力テーマが Intent 化前に整理されず、粒度判断が後続 phase に流れ込む | Discovery Brief に入力テーマ、判定、候補、推奨次アクションが残る | Intent 初期化、Ideation、Inception、実装 | なし |
...
recommended の Intent 候補を amadeus-intent-init に渡します。
